...
static AFTER_LONG_HELP: &str = color_print::cstr!(
    ...
    $ <bold>nise plugins update</bold>              # update all plugins
    $ <bold>nise plugins update cmake</bold>       # update only cmake
    $ <bold>nise plugins update cmake#beta</bold>  # specify a ref
"#
);
