...
- **Usage**: `nise ls-remote [FLAGS] [TOOL@VERSION] [PREFIX]`
...
$ nise ls-remote node --minimum-release-age 2024-01-01
20.0.0

$ nise ls-remote github:cli/cli --json
