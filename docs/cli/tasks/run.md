...
- **Usage**: `nise tasks run [FLAGS] [TASK] [ARGS]…`
- **Aliases**: `r`
...
These must be located in `mise-tasks`, `.mise-tasks`, `.mise/tasks`, `nise/tasks` or
`.config/mise/tasks`.
...
Tool(s) to run in addition to what is in nise.toml files e.g.: node@20 python@3.10
...
$ nise run lint ::: test ::: check

# Execute multiple tasks each with their own arguments.
$ nise run cmd1 arg1 arg2 ::: cmd2 arg1 arg2
```
