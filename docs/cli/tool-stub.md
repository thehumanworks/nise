...
- **Usage**: `nise tool-stub <FILE> [ARGS]…`
...
A tool stub consists of: - A shebang line: #!/usr/bin/env -S nise tool-stub - TOML configuration specifying the tool, version, and options - Optional comments describing the tool's purpose

Example stub file: #!/usr/bin/env -S nise tool-stub # Node.js v20 development environment
...
All arguments after the stub file path will be forwarded to the underlying tool. Use '--' to separate nise arguments from tool arguments if needed.
