...
- **Usage**: `nise dotfiles add [FLAGS] <TARGET>…`
...
```
$ nise dotfiles add ~/.zshrc
$ nise dotfiles add --mode copy ~/.config/starship.toml
$ nise dotfiles add --source dotfiles/gitconfig ~/.gitconfig
```
