...
# `nise bootstrap packages apply`

- **Usage**: `nise bootstrap packages apply [FLAGS] [PACKAGE]…`
- **Aliases**: `i`
...
```
$ nise bootstrap packages apply
$ nise bootstrap packages apply apk:zlib-dev apt:curl brew:jq brew-cask:firefox mas:497799835
$ nise bootstrap packages apply --dry-run
$ nise bootstrap packages apply --manager apt --yes
```
