...
- **Usage**: `nise install [FLAGS] [TOOL@VERSION]…`
- **Aliases**: `i`
...
```
$ nise install node@20.0.0  # install specific node version
$ nise install node@20      # install fuzzy node version
$ nise install node         # install version specified in nise.toml
$ nise install              # installs everything specified in nise.toml
```
