...
$ nise oci push ghcr.io/me/devenv:latest

Push an image built earlier:
$ nise oci build -o ./img
$ nise oci push --image-dir ./img ghcr.io/me/devenv:v1

Force a specific push tool:
$ nise oci push --tool crane ghcr.io/me/devenv:latest
```

Auth:

```
nise shells out to skopeo (preferred) or crane; configure registry
