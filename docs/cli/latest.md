...
- **Usage**: `nise latest [-i --installed] [--minimum-release-age <MINIMUM_RELEASE_AGE>] <TOOL@VERSION>`
...
```
$ nise latest node@20  # get the latest version of node 20
20.0.0

$ nise latest node     # get the latest stable version of node
20.0.0

$ nise latest node --minimum-release-age 2024-01-01  # latest stable node released before 2024-01-01
```
