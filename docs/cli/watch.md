...
- **Usage**: `nise watch [FLAGS] [TASK] [ARGS]…`
- **Aliases**: `w`
...
cron scheduling), see nise's sister project: https://pitchfork.jdx.dev
...
$ nise watch build --glob src/**/*.rs
Runs the "build" tasks but specify the files to watch with a glob pattern.
This overrides the "sources" from the tasks definition.

$ nise watch build --clear
Extra arguments are passed to watchexec. See `watchexec --help` for details.

$ nise watch serve --watch src --exts rs --restart
